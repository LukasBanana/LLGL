...
| Format::B5G6R5UNorm     | <b>\c  16</b> | \c  n5 | \c  n6 | \c  n5 |        |        |
| Format::BGRA4UNorm      | <b>\c  16</b> | \c  n4 | \c  n4 | \c  n4 | \c  n4 |        |
...
enum class Format
{
    ...
    BGRA4UNorm,         //!< Packed color format: blue, green, red, alpha 4-bit normalized unsigned integer components. \note Only supported with: OpenGL, Vulkan, Direct3D 11, Direct3D 12.
