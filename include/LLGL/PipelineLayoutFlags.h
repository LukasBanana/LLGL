...
struct PipelineLayoutDescriptor
{
    ...
    */
    STL::vector<BindingDescriptor>                  heapBindings;
    ...
    */
    STL::vector<BindingDescriptor>                  bindings;
    ...
    */
    STL::vector<StaticSamplerDescriptor>            staticSamplers;
    ...
    */
    STL::vector<CombinedTextureSamplerDescriptor>   combinedTextureSamplers;
