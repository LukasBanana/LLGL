...
/**
\defgroup group_strings Global type-to-STL::string conversion functions.
\addtogroup group_strings
@{
*/

/**
\brief Returns a STL::string representation for the specified ShaderType value, or null if the input type is invalid.
\remarks Return value examples are \c "vertex", \c "tessellation control".
*/
LLGL_EXPORT const char* ToString(const ShaderType val);

/**
\brief Returns a STL::string representation for the specified ErrorType value, or null if the input type is invalid.
...
/**
\brief Returns a STL::string representation for the specified WarningType value, or null if the input type is invalid.
...
/**
\brief Returns a STL::string representation for the specified ShadingLanguage value, or null if the input type is invalid.
\remarks Return value examples are \c "GLSL 450", \c "HLSL 2.0c".
*/
LLGL_EXPORT const char* ToString(const ShadingLanguage val);

/**
\brief Returns a STL::string representation for the specified Format value, or null if the input type is invalid.
...
/**
\brief Returns a STL::string representation for the specified ImageFormat value, or null if the input type is invalid.
\remarks Return value examples are \c "RGB", \c "ABGR".
*/
LLGL_EXPORT const char* ToString(const ImageFormat val);

/**
\brief Returns a STL::string representation for the specified TextureType value, or null if the input type is invalid.
\remarks Return value examples are \c "Texture1D", \c "Texture2DArray".
*/
LLGL_EXPORT const char* ToString(const TextureType val);

/**
\brief Returns a STL::string representation for the specified BlendOp value, or null if the input type is invalid.
\remarks Return value examples are \c "Zero", \c "SrcAlpha".
*/
LLGL_EXPORT const char* ToString(const BlendOp val);

/**
\brief Returns a STL::string representation for the specified ResourceType value, or null if the input type is invalid.
\remarks Return value examples are \c "buffer", \c "texture".
*/
LLGL_EXPORT const char* ToString(const ResourceType val);

/**
\brief Returns a STL::string representation for the specified SystemValue value, or null if the input type is invalid.
\remarks Return value examples are \c "Position", \c "ClipDistance".
*/
LLGL_EXPORT const char* ToString(const SystemValue val);

/**
\brief Returns a STL::string representation for the specified QueryType value, or null if the input type is invalid.
