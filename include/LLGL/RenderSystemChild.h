...
class LLGL_EXPORT RenderSystemChild : public Interface
{
    ...
    public:
        ...
        \remarks This function is especially useful in conjunction with diagnostic tools
        (such as <a href="https://renderdoc.org">RenderDoc</a>) to better identify objects in the event history.
        ...
        \see MeshPipelineDescriptor::debugName
