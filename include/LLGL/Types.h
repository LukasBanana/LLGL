...
\remarks If the operation results in a numerical overflow, the respective components will be clamped to its maximum, i.e. <code>std::numeric_limits<std::uint32_t>::max()</code>.
*/
...
\remarks If the operation results in a numerical overflow or underflow, the respective components will be clamped into the range <code>[std::numeric_limits<std::int32_t>::min(), std::numeric_limits<std::int32_t>::max()]</code>.
*/
