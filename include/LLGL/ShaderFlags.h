...
struct ShaderDescriptor
{
    ...
    */
    ...
    LLGL_DEPRECATED("ShaderDescriptor::vertex is deprecated since 0.05b; Use the `inputVertexFormat` and `outputVertexFormat` fields in LLGL::PipelineLayoutDescriptor instead")
