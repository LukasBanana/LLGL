...
LLGL_IMPLEMENT_INTERFACE( CommandBufferExt,         CommandBuffer           )
LLGL_IMPLEMENT_INTERFACE( CommandQueue,             RenderSystemChild       )
LLGL_IMPLEMENT_INTERFACE( ComputePipeline,          RenderSystemChild       )
LLGL_IMPLEMENT_INTERFACE( Fence,                    RenderSystemChild       )
LLGL_IMPLEMENT_INTERFACE( GraphicsPipeline,         RenderSystemChild       )
