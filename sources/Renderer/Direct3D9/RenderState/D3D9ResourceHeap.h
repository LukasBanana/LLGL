...
#ifndef LLGL_D3D9_RESOURCE_HEAP_H
#define LLGL_D3D9_RESOURCE_HEAP_H
...
class D3D9ResourceHeap final : public ResourceHeap
{
    ...
    public:
        ...
        D3D9ResourceHeap(const ResourceHeapDescriptor& desc, const ArrayView<ResourceViewDescriptor>& initialResourceViews = {});
