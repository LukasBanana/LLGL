...
static const char* DXErrorToStr(HRESULT hr)
{
    switch (hr)
    {
        ...
        //D3D9 - see https://learn.microsoft.com/en-us/windows/win32/direct3d9/d3derr
        LLGL_CASE_TO_STR( D3DERR_WRONGTEXTUREFORMAT );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDCOLOROPERATION );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDCOLORARG );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDALPHAOPERATION );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDALPHAARG );
        LLGL_CASE_TO_STR( D3DERR_TOOMANYOPERATIONS );
        LLGL_CASE_TO_STR( D3DERR_CONFLICTINGTEXTUREFILTER );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDFACTORVALUE );
        LLGL_CASE_TO_STR( D3DERR_CONFLICTINGRENDERSTATE );
        LLGL_CASE_TO_STR( D3DERR_UNSUPPORTEDTEXTUREFILTER );
        LLGL_CASE_TO_STR( D3DERR_CONFLICTINGTEXTUREPALETTE );
        LLGL_CASE_TO_STR( D3DERR_DRIVERINTERNALERROR );

        LLGL_CASE_TO_STR( D3DERR_NOTFOUND );
        LLGL_CASE_TO_STR( D3DERR_MOREDATA );
        LLGL_CASE_TO_STR( D3DERR_DEVICELOST );
        LLGL_CASE_TO_STR( D3DERR_DEVICENOTRESET );
        LLGL_CASE_TO_STR( D3DERR_NOTAVAILABLE );
        LLGL_CASE_TO_STR( D3DERR_OUTOFVIDEOMEMORY );
        LLGL_CASE_TO_STR( D3DERR_INVALIDDEVICE );
        LLGL_CASE_TO_STR( D3DERR_INVALIDCALL );
        LLGL_CASE_TO_STR( D3DERR_DRIVERINVALIDCALL );
        LLGL_CASE_TO_STR( D3DERR_WASSTILLDRAWING );
        LLGL_CASE_TO_STR( D3DOK_NOAUTOGEN );
