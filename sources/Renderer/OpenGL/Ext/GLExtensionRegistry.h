...
enum class GLExt
{
    ...
    ARB_texture_compression_bptc,       // GL 3.2
...
// Such mismatches can occurr when individual extensions are disabled either for debugging purposes or due to other external input.
