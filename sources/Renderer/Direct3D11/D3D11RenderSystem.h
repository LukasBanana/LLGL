...
class D3D11RenderSystem final : public RenderSystem
{
    ...
    private:
        ...
        HRESULT CreateDevice(IDXGIAdapter* adapter, bool debugDevice = false, bool softwareDevice = false);
        HRESULT CreateDeviceWithFlags(IDXGIAdapter* adapter, const ArrayView<D3D_FEATURE_LEVEL>& featureLevels, bool softwareDevice = false, UINT flags = 0);
