...
// Returns the SPIR-V builder (or rather generator) name by the specified builder magic number, or null if the magic number is unknown (see SPIRVHeader::builderMagic).
