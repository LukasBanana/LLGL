...
//   bits  w  h  c  format                     dataType
    ...
    {  16, 1, 1, 3, ImageFormat::BGR,          DataType::Undefined, GenMips | Dim1D_2D       | UNorm  | Packed          }, // B5G6R5UNorm
    {  16, 1, 1, 4, ImageFormat::BGRA,         DataType::Undefined, GenMips | Dim1D_2D       | UNorm  | Packed          }, // B4G4R4A4UNorm
