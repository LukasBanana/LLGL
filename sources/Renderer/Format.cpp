...
//   bits  w  h  c  format                     dataType             sRGB   compr  depth  stncl  norm   pack
    {  64, 4, 4, 4, ImageFormat::BC1,          DataType::UInt8,     false, true,  false, false, true,  false }, // BC1UNorm
    {  64, 4, 4, 4, ImageFormat::BC1,          DataType::UInt8,     true,  true,  false, false, true,  false }, // BC1UNorm_sRGB
    { 128, 4, 4, 4, ImageFormat::BC2,          DataType::UInt8,     false, true,  false, false, true,  false }, // BC2UNorm
    { 128, 4, 4, 4, ImageFormat::BC2,          DataType::UInt8,     true,  true,  false, false, true,  false }, // BC2UNorm_sRGB
    { 128, 4, 4, 4, ImageFormat::BC3,          DataType::UInt8,     false, true,  false, false, true,  false }, // BC3UNorm
    { 128, 4, 4, 4, ImageFormat::BC3,          DataType::UInt8,     true,  true,  false, false, true,  false }, // BC3UNorm_sRGB
    {  64, 4, 4, 1, ImageFormat::BC4,          DataType::UInt8,     false, true,  false, false, true,  false }, // BC4UNorm
    {  64, 4, 4, 1, ImageFormat::BC4,          DataType::Int8,      false, true,  false, false, true,  false }, // BC4SNorm
    { 128, 4, 4, 2, ImageFormat::BC5,          DataType::UInt8,     false, true,  false, false, true,  false }, // BC5UNorm
    { 128, 4, 4, 2, ImageFormat::BC5,          DataType::Int8,      false, true,  false, false, true,  false }, // BC5SNorm
};
