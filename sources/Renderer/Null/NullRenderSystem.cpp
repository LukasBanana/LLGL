...
static void InitNullRendererShadingLanguages(STL::vector<ShadingLanguage>& shadingLanguages)
{
    shadingLanguages =
    {
...
static void InitNullRendererTextureFormats(STL::vector<Format>& textureFormats)
{
