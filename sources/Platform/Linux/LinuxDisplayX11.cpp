...
{
    static LinuxSharedX11DisplaySPtr sharedX11Display = std::make_shared<LinuxSharedDisplayX11>();
...
/*
 * LinuxDisplayX11 class
 */

LinuxDisplayX11::LinuxDisplayX11(const std::shared_ptr<LinuxSharedDisplayX11>& sharedX11Display, int screenIndex) :
    sharedX11Display_ { sharedX11Display },
    screen_           { screenIndex      }
{
}

bool LinuxDisplayX11::IsPrimary() const
{
    return (screen_ == DefaultScreen(GetNative()));
}

UTF8String LinuxDisplayX11::GetDeviceName() const
{
    return UTF8String{ DisplayString(GetNative()) };
}

Offset2D LinuxDisplayX11::GetOffset() const
{
...
float LinuxDisplayX11::GetScale() const
{
    return 1.0f; // dummy
}

bool LinuxDisplayX11::ResetDisplayMode()
{
    //TODO
    return false;
}

bool LinuxDisplayX11::SetDisplayMode(const DisplayMode& displayMode)
{
...
DisplayMode LinuxDisplayX11::GetDisplayMode() const
{
...
std::vector<DisplayMode> LinuxDisplayX11::GetSupportedDisplayModes() const
{
...
::Display* LinuxDisplayX11::GetNative() const
{
