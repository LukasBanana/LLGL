...
static std::map<KeySym, Key> GenerateLinuxKeyCodeMap()
{
    return
    {
        ...
        KEYPAIR( 65438          , NumPad0   ),
        KEYPAIR( 65436          , NumPad1   ),
        KEYPAIR( 65433          , NumPad2   ),
        KEYPAIR( 65435          , NumPad3   ),
        KEYPAIR( 65430          , NumPad4   ),
        KEYPAIR( 65437          , NumPad5   ),
        KEYPAIR( 65432          , NumPad6   ),
        KEYPAIR( 65429          , NumPad7   ),
        KEYPAIR( 65431          , NumPad8   ),
        KEYPAIR( 65434          , NumPad9   ),
    
        KEYPAIR( XK_KP_Multiply , Multiply  ),
        KEYPAIR( XK_KP_Add      , Add       ),
        KEYPAIR( XK_KP_Separator, Separator ),
        KEYPAIR( XK_KP_Subtract , Subtract  ),
        KEYPAIR( XK_KP_Decimal  , Decimal   ),
        KEYPAIR( XK_KP_Divide   , Divide    ),
