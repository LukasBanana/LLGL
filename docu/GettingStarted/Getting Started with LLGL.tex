...
\begin{itemize}
	\item \textbf{OpenGL} \\
	OpenGL renderer is \textasciitilde 80\% complete
	
	\item \textbf{Direct3D 11} \\
	Direct3D 11 renderer is \textasciitilde 70\% complete
...
bufferDesc.usage = LLGL::BufferUsage::Static, // Staitc, because we won't write it frequently

// Set the vertex buffer specific attributes
bufferDesc.vertexBufferDesc.vertexFormat = vertexFormat; // Copy the vertex format
...
shaderProgram->BuildInputLayout(vertexFormat.GetAttributes());
