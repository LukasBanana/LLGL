...
{
	// Recreate GLFW window according to the new window descriptor ...
}
\end{lstlisting}
Now we cross over to the major functions in the \texttt{Window} interface. The first one is \texttt{Recreate}.
