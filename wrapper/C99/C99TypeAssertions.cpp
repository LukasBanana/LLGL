...
LLGL_STATIC_ASSERT_ENUM(Format, BGR5A1UNorm);
...
LLGL_STATIC_ASSERT_ENUM(Key, BrowserFavorits); // TODO: replace with BrowserFavorites
...
LLGL_STATIC_ASSERT_OFFSET(ProfileCommandQueueRecord, commandBufferSubmittions); // TODO: replace with commandBufferSubmissions
