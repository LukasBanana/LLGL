...
LLGL_STATIC_ASSERT_ENUM(SystemValue, ViewIndex);
...
LLGL_STATIC_ASSERT_OFFSET(RenderTargetDescriptor, views);
...
LLGL_STATIC_ASSERT_OFFSET(RenderPassDescriptor, views);
